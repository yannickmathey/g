exports.glyphs['f'] =
	...
	contours:
		0:
			...
			nodes:
				0:
					x: contours[3].nodes[0].x + 100 * width
				...
				3:
					...
					y: ascenderHeight - 10
					dirIn: 155 + 'deg'
					# dirIn: Utils.lineAngle( contours[0].nodes[3].expandedTo[1].point, contours[0].nodes[2].expandedTo[1].point )
					type: 'smooth'
					expand: Object({
		...
		2:
			...
			nodes:
				...
				1:
					...
					y: contours[0].nodes[3].expandedTo[0].y - 28
					dirIn: 90 + 'deg'
					type: 'smooth'
				2:
					x: contours[2].nodes[1].x - 4
					y: contours[2].nodes[1].y - 18
					typeOut: 'line'
					type: 'smooth'
				3:
