exports.glyphs['u'] =
	...
	anchors:
		0:
			x: 0 # contours[0].nodes[0].expandedTo[0].x + ( contours[1].nodes[0].expandedTo[1].x - contours[0].nodes[0].expandedTo[0].x ) * 0.5
			y: 0 # xHeight + diacriticHeight
	contours:
		0:
			skeleton: true
			closed: false
